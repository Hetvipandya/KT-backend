...
exports.addEmployee = async (req, res) => {
  try {
    ...
    if (rawRole === "teamlead" || rawRole === "teamleader" || Boolean(req.body.isTeamLead)) {
    ...
    let syncedUser = null;
    if (employeeRole === "employee" || employeeRole === "team lead" || employeeRole === "intern") {
...
exports.updateEmployee = async (req, res) => {
  try {
    ...
    if (rawUpdateRole === "teamlead" || rawUpdateRole === "teamleader" || req.body.isTeamLead === true) {
      roleValue = "team lead";
    } else if (rawUpdateRole === "intern") {
      roleValue = "intern";
