...
const buildInviteEmailContent = (inviterCompanyName, inviteLink) => {
  ...
  const html = wrapHtml(`
    ...
    <p style="margin: 24px 0;"><a class="button" href="${inviteLink}" style="background-color: #6366f1; color: #ffffff !important; padding: 14px 28px; text-decoration: none; border-radius: 8px; font-weight: 600; display: inline-block;">Set Password & Activate Account</a></p>
    <p>If the button above does not work, copy and paste this URL into your browser:</p>
    <p style="word-break: break-all; color: #6366f1;"><a href="${inviteLink}" style="color: #6366f1; text-decoration: underline;">${inviteLink}</a></p>
    <p style="margin-top: 20px; color: #777;">If you did not expect this invite, please ignore this email or contact your administrator.</p>
  `);
